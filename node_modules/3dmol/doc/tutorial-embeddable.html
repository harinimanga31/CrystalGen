...
</code></pre><div style="height:500px;width:500px;position:relative" class="viewer_3Dmoljs" data-pdb="2POR" data-backgroundcolor="0xffffff" data-style="stick" data-ui="true"></div><p>The contents of the viewer can be set and manipulated through the use of <code>data-</code> tags, as shown above. Supported tags include:</p><ul><li><strong>data-pdb</strong> The value describes a PDB ID to be loaded into the viewer.</li><li><strong>data-cid</strong> The value describes a PubChem compound id to be loaded into the viewer.</li><li><strong>data-href</strong> The value is a URL to a molecular data file.</li><li><strong>data-element</strong> The value is the id of an HTML element on the current page that has molecular data embedded in it.</li><li><strong>data-type</strong> The value is the file format (default pdb; can be pdb, sdf, xyz, mol2, or cube).</li><li><strong>data-backgroundcolor</strong> The background color (default black).</li><li><strong>data-backgroundalpha</strong> The background alpha (default opaque: 1.0).</li><li><strong>data-select</strong> The value is an <a href="AtomSpec.html"><code>AtomSpec</code></a> selection specification.</li><li><strong>data-style</strong> The value is a style specification.</li><li><strong>data-surface</strong> A surface style specification.</li><li><strong>data-labelres</strong> A residue label style specification.</li><li><strong>data-zoomto</strong> An <a href="AtomSpec.html"><code>AtomSpec</code></a> selection specification to zoom to.</li><li><strong>data-spin</strong> If set will spin the model using <a href="GLViewer.html#spin"><code>GLViewer#spin</code></a>. Can specify axis and speed (e.g. data-spin='axis:z;speed:10')</li><li><strong>data-callback</strong> JavaScript function to call upon viewer creation. Receives <a href="GLViewer.html"><code>GLViewer</code></a> object as argument.</li><li><strong>data-ui</strong> If set will show the UI for the viewer.</li></ul><p>Multiple selections, styles, residue labels, and surfaces can be provided by appending a suffix<br>each tag.</p><p>For example:</p><pre class="prettyprint source lang-{@lang"><code>         &lt;div style=&quot;height: 400px; width: 400px; position: relative;&quot; class='viewer_3Dmoljs' data-pdb='1YCR' 
